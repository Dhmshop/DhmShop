...
public class OnSuccessAndFaultSub<T> extends DisposableObserver<BaseInfo<T>>
     ...
     */
    public OnSuccessAndFaultSub(OnSuccessAndFaultListener<T> mOnSuccessAndFaultListener) {
     ...
     * @param context                    上下文
     */
    public OnSuccessAndFaultSub(OnSuccessAndFaultListener<T> mOnSuccessAndFaultListener, Activity context) {
        this.mOnSuccessAndFaultListener = mOnSuccessAndFaultListener;
        this.context = context;
//        progressDialog = new Dialog(context, R.style.custom_dialog2);
//        View inflate = LayoutInflater.from(context).inflate(R.layout.refresh_layout, null);
//        ImageView emptyImage = inflate.findViewById(R.id.emptyImage);
//        Glide.with(context)
//                .load(context.getResources().getDrawable(R.drawable.refresh))
//                .into(emptyImage);
//        progressDialog.setContentView(inflate);
     ...
     */
    public OnSuccessAndFaultSub(OnSuccessAndFaultListener<T> mOnSuccessAndFaultListener, Activity context, boolean showProgress) {
        this.mOnSuccessAndFaultListener = mOnSuccessAndFaultListener;
        this.context = context;
    ...
    private void dismissProgressDialog() {
        if (showProgress && null != progressDialog && progressDialog.isShowing() && !context.isDestroyed()) {
    ...
    public void onError(Throwable e) {
        try {
            if (e instanceof SocketTimeoutException) {//请求超时
                ...
                mOnSuccessAndFaultListener.onFault("网络解析错误");
            } else {
     ...
     */
    @Override
    public void onNext(BaseInfo<T> body) {
